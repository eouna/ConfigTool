...
// =================== 模板结束 ===================
import ${containerPackageName}.BaseCfgContainer.ContainerExceptionBlocker;
...
public class ${dataManagerClassName} {
   ...
   * @throws Exception e
   */
  public static void ${loadMethodName}(String excelResourcePath) throws Exception {
   ...
   * @throws Exception e
   */
  public static void ${loadMethodName}(String excelResourcePath, boolean useMultiThreadAcc) throws Exception {
   ...
   * @throws Exception e
   */
  public static void ${loadMethodName}(
...
<#list beanAndContainerMap as key,value>
  ...
  public static Map<Integer, ${key}> get${key}Map() {
    return getInstance().getCfgContainer(${key}.class).getCfgBeanMap();
  }

  public static List<${key}> get${key}List() {
